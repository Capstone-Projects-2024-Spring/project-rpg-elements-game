...
namespace Tests
{
    public class NewTestScript
    {
        ...
        public IEnumerator NewTestScriptWithEnumeratorPasses()
        {
            ...
            LogAssert.Expect(LogType.Error, "![CDATA[Unhandled log message: '[Error] [Steamworks.NET] SteamAPI_Init() failed. Refer to Valve's documentation or the comment above this line for more information.'. Use UnityEngine.TestTools.LogAssert.Expect]]");
